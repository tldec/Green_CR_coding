...
def KMWIS():
    ...
    for e in range(len(epsilons)):
        ...
        for w in range((len(weights))):
            ...
            trafficOverSlotE[w, e] = np.average(trafficOverSlot[1:, w])
...
def compareEpsilon():
    ...
    traff_dict = {}
    utility_dict = {}
    har_dict["xlabel"] = "Value of Epsilons"
    har_dict["ylabel"] = "Average Data Harvested of IoT Nodes"
    har_dict["title"] = "Average Data Harvested Comparation under Epsilons"
    har_dict["para_name"] = "V"
    plotUtilityOverWeights(epsilons, harMw, weights, har_dict)

    drop_dict["xlabel"] = "Value of Epsilons"
    drop_dict["ylabel"] = "Average Data-drops of IoT Nodes "
    drop_dict["title"] = "Dropped Data under Different Epsilons"
    drop_dict["para_name"] = "V"
    plotUtilityOverWeights(epsilons, dropMw, weights, drop_dict)

    traff_dict["xlabel"] = "Value of Epsilons"
    traff_dict["ylabel"] = "Average Traffics of IoT Nodes"
    traff_dict["title"] = "Dropped Data under Different Epsilons"
    traff_dict["para_name"] = "V"
    plotUtilityOverWeights(epsilons, trafficOverSlotE, weights, traff_dict)

    utility_dict["xlabel"] = "Value of Epsilons"
    utility_dict["ylabel"] = "Network Utility"
    utility_dict["title"] = "Network Utility under Different Epsilons"
    utility_dict["para_name"] = "V"
    plotUtilityOverWeights(epsilons, aveUtility, weights, utility_dict)
